...
<div id="div_left_margin">				
		<ul>
			...
			<li class="menu_item_click"><a href="<?=base_url()?>admin/news/add"><?=lang('news_add')?></a></li>
...
<div id ="div_right">		
	<ul>
		<li class="li_title"><?=lang('news_add')?></li>
		<li>
			<form method="post" action="<?=base_url()?>admin/news/add">
