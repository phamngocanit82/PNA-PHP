...
function edit_check(){
	...
	<div id="div_left_margin">				
		<ul>
			...
			<li class="menu_item_click"><a href="<?=base_url()?>admin/product/promotion">Bao nylon PE</a></li>	
...
<div id ="div_right">		
	<ul>
		<li class="li_title"><?=lang('product_list')?> khuyến mãi</li>
		<li>
			...
			<table class="table_list" border="0" cellspacing="0">
				<tr>
					...
					<th class="th_right">Khuyến mãi</th>
				</tr>
				<?php 	
				if($product)	
					$idcategory = '';
				...
				<tr>
					...
					<td valign="top" align="center" style="color:#fff;background-color:#56b44c;border-left:solid 1px #ffffff;border-right:solid 1px #ffffff;border-bottom:solid 1px #ffffff;">
						<a href="<?=base_url()?>admin/product/checkpromotion/<?=$page?>/<?=$row->id?>/0"><b>Không</b></a>
					</td>
					<?php
					}
					else{
					...
					<td valign="top" align="center" style="color:#000;background-color:#b2d6de;border-left:solid 1px #ffffff;border-right:solid 1px #ffffff;border-bottom:solid 1px #ffffff;">
						<a href="<?=base_url()?>admin/product/checkpromotion/<?=$page?>/<?=$row->id?>/1"><b>Có</b></a>
					</td>
					<?php
					}
					?>					
