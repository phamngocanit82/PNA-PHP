...
?>
<div class="right">
	<div id="title"><label>Bảng lương PH tham khảo</label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/salary_reference/save">
		<div>	
	    	<table id="table_add">
			    <tr>
