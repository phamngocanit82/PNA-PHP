...
function CheckDelete(id,page){	
	...
	if (answer){
		window.location = "<?=base_url()?>admin/exam_question_tsdh/deleteImage/"+id+"/"+page;
	}
}
</script>
<div class="right">
	<div id="title"><label><?php echo(lang('admin_exam_question_tsdh'))?></label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/exam_question_tsdh/save_edit/<?php echo($id)?>/<?php echo($page)?>" enctype="multipart/form-data">
		<div>	
	    	<table id="table_add">
	    	 	<tr>
