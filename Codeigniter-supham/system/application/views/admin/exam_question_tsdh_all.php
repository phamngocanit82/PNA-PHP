...
function CheckDelete(id){	
	...
	if (answer){
		window.location = "<?=base_url()?>admin/exam_question_tsdh/delete/"+id;
	}
}
</script>
<div class="right">
	<div id="title"><label><?php echo(lang('admin_management_exam_question_tsdh').' TSĐH')?></label></div>
	<?php 
	...
	?>
		<div style="float:left">
			<div class="newstitle">
				<a href="<?=base_url()?>admin/exam_question_tsdh/view/<?php echo($row->id)?>"><?php echo($row->title)?></a>
				<a href="javascript:void(0)" onclick="CheckDelete(<?php echo$row->id ;?>)">
					...
					|
				<a href="<?=base_url()?>admin/exam_question_tsdh/edit/<?php echo($row->id)?>/<?php echo($page)?>" >
