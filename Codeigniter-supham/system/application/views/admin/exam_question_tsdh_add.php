...
?>
<div class="right">
	<div id="title"><label><?php echo(lang('admin_add_exam_question_tsdh').' TSĐH')?></label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/exam_question_tsdh/save_add" enctype="multipart/form-data">
		<div>	
	    	<table id="table_add">
	    	 	<tr>
