...
?>
<div class="right">
	<div id="title"><label><?echo(lang('why_need_teacher'))?></label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/why_need_teacher/save">
		<div>	
	    	<table id="table_add">
			    <tr>
