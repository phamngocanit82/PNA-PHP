...
function CheckDelete(id,page){	
	...
	if (answer){
		window.location = "<?=base_url()?>admin/news/deleteImage/"+id+"/"+page;
	}
}
</script>
<div class="right">
	<div id="title"><label><?php echo(lang('admin_news'))?></label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/news/save_edit/<?php echo($id)?>/<?php echo($page)?>" enctype="multipart/form-data">
		<div>	
	    	<table id="table_add">
	    	 	<tr>
		    	...
		    	<tr>
		    		...
		    		<td align="left"><input class="input_file" type="file" id="avatar" name="avatar"/> &nbsp;<?php echo(lang('require_image'))?></td>		      
		    	</tr>
		    	<?php	
		    	}
		    	?>
