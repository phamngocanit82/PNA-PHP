...
?>
<div class="right">
	<div id="title"><label><?php echo(lang('admin_add_announcement'))?></label></div>
	<form class="admin_form" id="frm_admin_add" method="post" action="<?php echo(base_url())?>admin/announcement/save_add" enctype="multipart/form-data">
		<div>	
	    	<table id="table_add">
	    	 	<tr>
