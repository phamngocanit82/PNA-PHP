<div class="center1">
    <div id="register_title"><?php echo(lang('teacher_quality'))?></div>    
		...
		?>			
			...
			<tr>
				<td colspan="3" align="right">				
					<a align="right" href="<?php echo(base_url())?>teacher_quality/view/<?php echo($row->id)?>"><small><?php echo(lang('continue'))?></small></a>
				</td>				
			</tr>
     	</table>  
     	<div></div>
