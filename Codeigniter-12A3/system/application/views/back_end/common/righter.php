	...
	<div id="login">
		<form  style="padding:0px;margin:0px;" id="frm_leftsignin" method="post" action="<?=base_url()?>/user/login">	
			...
			<div>
				...
				<a href="#" onclick="return hs.htmlExpand(this,{contentId: 'forgotpass' })">&nbsp;<span id="forgot_your">|</span>&nbsp;<span id="forgot_your">Forgot your</span>&nbsp;<span id="password">password?</span></a>
			</div>
		</form>
	</div>
